...
const SaasLandingPage = () => {
  ...
  const features = [
    {
      ...
      description:
        "Complete data isolation and security for each construction company",
    ...
    },
    {
      ...
      description:
        "Role-based permissions for owners, admins, managers, and field workers",
      color: "from-purple-500 to-pink-500",
    },
    {
      icon: <BarChart3 className="h-8 w-8" />,
      title: "Advanced Analytics",
      description: "Real-time insights and reporting for project performance",
    ...
    },
    {
      ...
      description:
        "Optimized performance for large-scale construction operations",
      color: "from-yellow-500 to-amber-500",
    },
    {
      icon: <Globe className="h-8 w-8" />,
      title: "Global Scale",
      description: "Deploy worldwide with multi-region support and CDN",
  ...
  const testimonials = [
    {
      ...
      content:
        "This platform transformed how we manage our construction projects. The multi-tenant architecture is exactly what we needed.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      role: "Operations Director, Urban Builders",
      content:
        "The role-based permissions and real-time analytics have improved our team efficiency by 40%.",
      rating: 5,
    },
    {
      name: "Emily Rodriguez",
      role: "Project Manager, Green Construction",
      content:
        "Best construction CRM we've used. The interface is intuitive and the features are comprehensive.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-900 dark:bg-slate-900 text-white dark:text-white overflow-x-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-pink-500/20 to-orange-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Manage multiple construction company tenants with our powerful
            administration platform. Monitor usage, handle subscriptions, and
            oversee your entire SaaS ecosystem from one central dashboard.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Everything you need to manage construction projects at scale with
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              See what construction industry leaders are saying about our
              platform.
            </p>
          </div>
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Choose the perfect plan for your construction company. All plans
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-xl rounded-3xl p-12 border border-slate-700/50">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Join thousands of construction companies already using our
              platform to streamline operations and boost productivity.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Button
                onClick={() => navigate("/login/admin")}
      ...
      <footer className="relative z-10 px-6 py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="text-slate-400 text-sm">
              © 2024 JobBlox Admin. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
